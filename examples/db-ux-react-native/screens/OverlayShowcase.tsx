      ...
      <Section title="Popover — basic">
        ...
        <DBPopover open={popoverOpen}>
          <DBCard elevationLevel="3">
            <Text style={styles.popoverTitle}>Popover content</Text>
...
const styles = StyleSheet.create({
  ...
  popoverTitle: { fontSize: 16, fontWeight: "700", marginBottom: 8, color: "#2e3036" },
  popoverBody: { fontSize: 14, lineHeight: 20, color: "#2e3036" },
