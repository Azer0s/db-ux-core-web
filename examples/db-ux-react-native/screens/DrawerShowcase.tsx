  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <DBDrawer
        ...
        drawerHeader={<Text style={styles.drawerTitle}>Left drawer</Text>}
      >
      ...
      <DBDrawer
        ...
        drawerHeader={<Text style={styles.drawerTitle}>Right drawer</Text>}
      >
        <View style={styles.drawerContent}>
          <Text style={styles.drawerBody}>
          ...
          <DBCard elevationLevel="1">
            <Text style={styles.drawerBody}>Cards work inside drawers too.</Text>
          </DBCard>
      ...
      <DBDrawer
        ...
        drawerHeader={<Text style={styles.drawerTitle}>Bottom sheet</Text>}
      >
        <View style={styles.drawerContent}>
          <Text style={styles.drawerBody}>
...
const styles = StyleSheet.create({
  ...
  hint: { fontSize: 13, color: "#5a5e68", lineHeight: 18 },
  drawerTitle: { fontSize: 18, fontWeight: "700", color: "#2e3036" },
  drawerContent: { padding: 16, gap: 16 },
  drawerBody: { fontSize: 14, lineHeight: 20, color: "#2e3036" },
});
